...
abstract contract GivPaymentSplitter {
    ...
    constructor(
        ...
        require(
            ...
            "GivPaymentSplitter: payees and shares length mismatch"
        );
        require(payees.length > 0, "GivPaymentSplitter: no payees");
    ...
    function release(address account) public virtual {
        require(
            _shares[account] > 0,
            "GivPaymentSplitter: account has no shares"
        );
        ...
        require(
            payment != 0,
            "GivPaymentSplitter: account is not due payment"
        );
    ...
    function _addPayee(address account, uint256 shares_) internal {
        require(
            account != address(0),
            "GivPaymentSplitter: account is the zero address"
        );
        require(shares_ > 0, "GivPaymentSplitter: shares are 0");
        require(
            _shares[account] == 0,
            "GivPaymentSplitter: account already has shares"
        );
